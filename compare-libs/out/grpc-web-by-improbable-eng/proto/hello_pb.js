...
goog.exportSymbol('proto.hello.Profile', null, global);
...
proto.hello.HelloResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    message: jspb.Message.getFieldWithDefault(msg, 1, ""),
    profile: (f = msg.getProfile()) && proto.hello.Profile.toObject(includeInstance, f)
  };
...
proto.hello.HelloResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.hello.Profile;
      reader.readMessage(value,proto.hello.Profile.deserializeBinaryFromReader);
...
proto.hello.HelloResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.hello.Profile.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {?proto.hello.Profile}
 */
proto.hello.HelloResponse.prototype.getProfile = function() {
  return /** @type{?proto.hello.Profile} */ (
    jspb.Message.getWrapperField(this, proto.hello.Profile, 2));
};


/** @param {?proto.hello.Profile|undefined} value */
proto.hello.HelloResponse.prototype.setProfile = function(value) {
  jspb.Message.setWrapperField(this, 2, value);
};


proto.hello.HelloResponse.prototype.clearProfile = function() {
 ...
 * @return {!boolean}
 */
proto.hello.HelloResponse.prototype.hasProfile = function() {
 ...
 * @constructor
 */
proto.hello.Profile = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.hello.Profile, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.hello.Profile.displayName = 'proto.hello.Profile';
}
 ...
 * @return {!Object}
 */
proto.hello.Profile.prototype.toObject = function(opt_includeInstance) {
  return proto.hello.Profile.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.hello.Profile} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.hello.Profile.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.hello.Profile}
 */
proto.hello.Profile.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.hello.Profile;
  return proto.hello.Profile.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.hello.Profile} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.hello.Profile}
 */
proto.hello.Profile.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.hello.Profile.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.hello.Profile.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.hello.Profile} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.hello.Profile.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getName();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.hello.Profile.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.hello.Profile.prototype.setName = function(value) {
  jspb.Message.setProto3StringField(this, 1, value);
};
